    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Later we willinterpolate these waypoints with a spline and fill it in with more points and control the speed
          vector<double> ptsx;
          vector<double> ptsy;
          // reference x,y,yaw states
          // either we will reference the starting point as where the car is or at the previous pathsend point
          double ref_x = car_x;
          double ref_y = car_y;
          ...
          // use the prevous paths end point as starting reference
          else
          {
